...
public class TwitterCOVIDConsumer {
    ...
    public static KafkaConsumer<String,String> createConsumer(String topic){
        ...
        String groupId = "kafka_demo_elasticsearchcovid";
    ...
    public static void main(String[] args) throws IOException {
        Logger logger = LoggerFactory.getLogger(TwitterCOVIDConsumer.class.getName());
        RestHighLevelClient client = createClient();


        KafkaConsumer<String,String> consumer = createConsumer("covid_tweets");

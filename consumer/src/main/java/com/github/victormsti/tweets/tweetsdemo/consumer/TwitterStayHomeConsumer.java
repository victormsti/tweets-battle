...
public class TwitterStayHomeConsumer {
    ...
    public static KafkaConsumer<String,String> createConsumer(String topic){
        ...
        String groupId = "kafka_demo_elasticsearchsh";
    ...
    public static void main(String[] args) throws IOException {
        Logger logger = LoggerFactory.getLogger(TwitterStayHomeConsumer.class.getName());
        RestHighLevelClient client = createClient();


        KafkaConsumer<String,String> consumer = createConsumer("fique_em_casa_tweets");

...
public class TwitterBolsonaroConsumer {
    ...
    public static KafkaConsumer<String,String> createConsumer(String topic){
        ...
        String groupId = "kafka_demo_elasticsearch1";
    ...
    public static void main(String[] args) throws IOException {
        Logger logger = LoggerFactory.getLogger(TwitterBolsonaroConsumer.class.getName());
        RestHighLevelClient client = createClient();


        KafkaConsumer<String,String> consumer = createConsumer("bolsonaro_tweets");

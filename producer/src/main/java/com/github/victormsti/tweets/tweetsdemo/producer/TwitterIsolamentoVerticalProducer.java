...
public class TwitterIsolamentoVerticalProducer {
    Logger logger = LoggerFactory.getLogger(TwitterIsolamentoVerticalProducer.class.getName());
    ...
    List<String> terms = Lists.newArrayList("Isolamento vertical", "Vertical insulation");
    public TwitterIsolamentoVerticalProducer(){}

    public static void main(String[] args) {
        new TwitterIsolamentoVerticalProducer().run();
    ...
    public void run (){
        ...
        while (!client.isDone()) {
            ...
            if(msg != null){
                ...
                producer.send(new ProducerRecord<>("isolamento_vertical_tweets", null, msg), new Callback() {
                    @Override
                    public void onCompletion(RecordMetadata metadata, Exception exception) {
                        logger.info("Isolamento vertical msg sent to Kafka");
                        if(exception != null){

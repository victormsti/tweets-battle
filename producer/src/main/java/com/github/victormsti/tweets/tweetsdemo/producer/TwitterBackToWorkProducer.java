...
public class TwitterBackToWorkProducer {
    Logger logger = LoggerFactory.getLogger(TwitterBackToWorkProducer.class.getName());
    ...
    List<String> terms = Lists.newArrayList("Back to work","Voltar a trabalhar");
    public TwitterBackToWorkProducer(){}

    public static void main(String[] args) {
        new TwitterBackToWorkProducer().run();
    ...
    public void run (){
        ...
        while (!client.isDone()) {
            ...
            if(msg != null){
                ...
                producer.send(new ProducerRecord<>("voltar_a_trabalhar_tweets", null, msg), new Callback() {
                    @Override
                    public void onCompletion(RecordMetadata metadata, Exception exception) {
                        logger.info("Voltar a trabalhar msg sent to Kafka");
                        if(exception != null){

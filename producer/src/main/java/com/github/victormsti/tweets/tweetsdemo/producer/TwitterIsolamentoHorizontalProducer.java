...
public class TwitterIsolamentoHorizontalProducer {
    Logger logger = LoggerFactory.getLogger(TwitterIsolamentoHorizontalProducer.class.getName());
    ...
    List<String> terms = Lists.newArrayList("Isolamento vertical", "Horizontal insulation");
    public TwitterIsolamentoHorizontalProducer(){}

    public static void main(String[] args) {
        new TwitterIsolamentoHorizontalProducer().run();
    ...
    public void run (){
        ...
        while (!client.isDone()) {
            ...
            if(msg != null){
                ...
                producer.send(new ProducerRecord<>("isolamento_horizontal_tweets", null, msg), new Callback() {
                    @Override
                    public void onCompletion(RecordMetadata metadata, Exception exception) {
                        logger.info("Isolamento horizontal msg sent to Kafka");
                        if(exception != null){

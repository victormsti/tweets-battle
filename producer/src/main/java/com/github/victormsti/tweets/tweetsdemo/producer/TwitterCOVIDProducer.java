...
public class TwitterCOVIDProducer {
    Logger logger = LoggerFactory.getLogger(TwitterCOVIDProducer.class.getName());
    ...
    List<String> terms = Lists.newArrayList("COVID","Coronavirus","Coronavírus");
    public TwitterCOVIDProducer(){}

    public static void main(String[] args) {
        new TwitterCOVIDProducer().run();
    ...
    public void run (){
        ...
        while (!client.isDone()) {
            ...
            if(msg != null){
                ...
                producer.send(new ProducerRecord<>("covid_tweets", null, msg), new Callback() {
                    @Override
                    public void onCompletion(RecordMetadata metadata, Exception exception) {
                        logger.info("COVID msg sent to Kafka");
                        if(exception != null){

...
public class TwitterBolsonaroProducer {
    Logger logger = LoggerFactory.getLogger(TwitterBolsonaroProducer.class.getName());
    ...
    public TwitterBolsonaroProducer(){}

    public static void main(String[] args) {
        new TwitterBolsonaroProducer().run();
    ...
    public void run (){
        ...
        while (!client.isDone()) {
            ...
            if(msg != null){
                ...
                producer.send(new ProducerRecord<>("bolsonaro_tweets", null, msg), new Callback() {
                    @Override
                    public void onCompletion(RecordMetadata metadata, Exception exception) {
                        logger.info("Bolsonaro msg sent to Kafka");
                        if(exception != null){

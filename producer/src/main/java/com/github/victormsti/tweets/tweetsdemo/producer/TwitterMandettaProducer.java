...
public class TwitterMandettaProducer {
    Logger logger = LoggerFactory.getLogger(TwitterMandettaProducer.class.getName());
    ...
    List<String> terms = Lists.newArrayList("Mandetta");
    public TwitterMandettaProducer(){}

    public static void main(String[] args) {
        new TwitterMandettaProducer().run();
    ...
    public void run (){
        ...
        while (!client.isDone()) {
            ...
            if(msg != null){
                ...
                producer.send(new ProducerRecord<>("mandetta_tweets", null, msg), new Callback() {
                    @Override
                    public void onCompletion(RecordMetadata metadata, Exception exception) {
                        logger.info("Mandetta msg sent to Kafka");
                        if(exception != null){
